...
import facebook from "../assets/Platform=Facebook, Color=Original.png";
import youtube from "../assets/Platform=YouTube, Color=Original.png";
import instagram from "../assets/Platform=Instagram, Color=Original.png";
import thread from "../assets/Platform=Threads, Color=Original.png";
    ...
    <div>
      <div className="flex flex-col bg-richblue items-center pt-12 pb-2 gap-16">
        <div className="flex flex-col gap-5 items-center">
          ...
          <div className="font-noticia font-normal leading-normal text-base text-white flex gap-3">
        ...
        <div className="flex gap-2 font-nokora font-normal leading-normal text-sm text-grey-text2">
